function makeResizableDiv(div) {
    ...
    let ic_top = imageContainer.getBoundingClientRect().top;
    let ic_left = imageContainer.getBoundingClientRect().left;
    let ic_bottom = imageContainer.getBoundingClientRect().bottom;
    let ic_right = imageContainer.getBoundingClientRect().right;

    console.log(ic_top,ic_bottom,ic_left,ic_right);
    let offset = [0,0];
